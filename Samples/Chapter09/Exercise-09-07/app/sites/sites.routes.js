...
exports.sitesRoutes = [
    {
        ...
        children: [
            ...
            { path: 'add', component: add_site_component_1.AddSiteComponent, canDeactivate: [deactivable_guard_1.CanDeactivateGuard] },
            { path: 'edit/:id', component: edit_site_component_1.EditSiteComponent, canDeactivate: [deactivable_guard_1.CanDeactivateGuard] },
